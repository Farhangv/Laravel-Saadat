...
use \BookStore\DataMapper\BookMapper;
...
/* 
//---------------------- End Before Data Mapping -----------------------------
*/


$mapper = new BookMapper(new Database(Config::getInstance()));
$book = $mapper->getById(7);
var_dump($book);
var_dump($book->getAllMembers());
echo $book->id;
